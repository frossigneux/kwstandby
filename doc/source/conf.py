# -*- coding: utf-8 -*-
#
# Kwstandby documentation build configuration file, created by
...
def write_autodoc_index():
    ...
    EXCLUDED_MODULES = ['kwstandby.tests']
    CURRENT_SOURCES = {}
...
htmlhelp_basename = 'Kwstandbydoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'Kwstandby.tex', u'Kwstandby Documentation',
...
man_pages = [
    ('index', 'Kwstandby', u'Kwstandby Documentation',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Kwstandby', u'Kwstandby Documentation', u'OpenStack',
     'Kwstandby', 'One line description of project.', 'Miscellaneous'),
]
